...
<body>
    ...
    <div id="declaraciones">
        ...
        <div id="vision" class="tarjetas alinear shadow">
            ...
            <p>
                ...
                y seguro para complementar sus terapias, facilitando la comunicación y fluidez de las sesiones con el usuario y su terapeuta.
            </p>
        </div>
        <div id="mision" class="tarjetas alinear shadow">
            <h2>Misión</h2>
            <p>
                Entregar una página web simple, con un espacio donde se pueda escribir diferentes registros en diferentes áreas dependiendo de las necesidades entrantes,
                brindando un panel amigable para escribir sobre eventos cortos del día, narrar un día del usuario,
                agregar un recordatorio de tareas que le presente su terapeuta e incluso un lugar donde pueda registrar sus recetas médicas.
    ...
    <div id="donacion" class="shadow">
        ...
        <p>
            ...
            se mantiene por medio de publicidades que se muestran en ciertas partes del sitio web. Mas, si deseas apoyar nuestro proyecto,
            tenemos habilitado un patreon para recibir donaciones, las cuales se usarán para continuar pagando el dominio e implementar mejoras en el mismo
        </p>
